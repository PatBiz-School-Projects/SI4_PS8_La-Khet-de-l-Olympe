    ...
    async connectedCallback() {
        try {
            ...
            const [htmlResponse, cssResponse] = await Promise.all([
                apiFetch("/auth/components/signup-form/signup-form.html"),
                apiFetch("/auth/components/signup-form/signup-form.css"),
            ]);
        ...
        form.onsubmit = async (event) => {
            ...
            if (!questionInput.value.trim() || !answerInput.value.trim()) {
                this._setStatus("Veuillez renseigner votre question et votre réponse secrète.", "error");
                return;
            }
            ...
            try {
                ...
                this._setStatus(payload.detail , "ok");
            } catch {
